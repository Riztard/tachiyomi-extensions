...
abstract class Comick(
    ...
    private val apiUrl = "https://api.comick.dev"
    ...
    override val client = network.cloudflareClient.newBuilder()
        ...
        .rateLimit(10, 6, TimeUnit.SECONDS) // == 100req each (60sec / 1min)
        .build()
    ...
    override fun chapterListParse(response: Response): List<SChapter> {
        ...
        val finalChapters = if (preferredGroups.isEmpty()) {
            ...
            chaptersByNumber.forEach { (_, chaptersForNumber) ->
                ...
                val preferredChapter = preferredGroups.firstNotNullOfOrNull { preferredGroup: String ->
    ...
    companion object {
        ...
        private const val PAGE_LIST_TOAST = "Chapter pages are no longer available / provided from this site."
