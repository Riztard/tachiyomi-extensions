...
class ShinigamiX2 : ConfigurableSource, HttpSource() {
    ...
    override fun popularMangaParse(response: Response): MangasPage {
        val rootObject = response.parseAs<ShinigamiX2BrowseDto>()
    ...
    private fun popularMangaFromObject(obj: ShinigamiX2BrowseDataDto): SManga = SManga.create().apply {
    ...
    override fun mangaDetailsParse(response: Response): SManga {
        val mangaDetailsResponse = response.parseAs<ShinigamiX2MangaDetailDto>()
    ...
    override fun chapterListParse(response: Response): List<SChapter> {
        val result = response.parseAs<ShinigamiX2ChapterListDto>()

        return result.chapterList.map(::chapterFromObject)
    }

    private fun chapterFromObject(obj: ShinigamiX2ChapterListDataDto): SChapter = SChapter.create().apply {
    ...
    override fun pageListParse(response: Response): List<Page> {
        val result = response.parseAs<ShinigamiX2PageListDto>()
